  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '100px 0' }}>
        <p style={{ fontSize: '1.2rem', color: 'var(--primary-color)' }}>Đang tải danh sách sản phẩm...</p>
      </div>
    );
  }
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '100px 1fr', gap: '15px', alignItems: 'center' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    {uploading && <span style={{ color: 'var(--primary-color)', fontSize: '0.8rem' }}>Đang tải ảnh...</span>}
                  </div>
                </div>
